...
## [0.2.0](https://github.com/birhantprkc/deepagents/compare/deepagents-code==0.1.56...deepagents-code==0.2.0) (2026-08-16)


### ⚠ BREAKING CHANGES

* **sdk,code,quickjs:** make the `ToDoListMiddleware` list opt-in ([#4929](https://github.com/birhantprkc/deepagents/issues/4929))

### Features

* **code,evals:** GLM-5.2 harness profile ([#4710](https://github.com/birhantprkc/deepagents/issues/4710)) ([47cfc33](https://github.com/birhantprkc/deepagents/commit/47cfc33cf9145347b57eb2daf6ef82cdaa342ca4))
* **code:** `/model` footer Ctrl+N hint follows display mode ([#5247](https://github.com/birhantprkc/deepagents/issues/5247)) ([cf87266](https://github.com/birhantprkc/deepagents/commit/cf87266105ee6ed79e56d72dea58c1c5f431228f))
* **code:** `Ctrl+S` in `/auto model` stores `[models].auto_classifier` ([#5313](https://github.com/birhantprkc/deepagents/issues/5313)) ([e742d04](https://github.com/birhantprkc/deepagents/commit/e742d04c8ca6f615327d7d1eab7994be8fcb3000))
* **code:** `dcode config get` accepts sections ([#5134](https://github.com/birhantprkc/deepagents/issues/5134)) ([874a137](https://github.com/birhantprkc/deepagents/commit/874a137f7bf694f647f6f1dcbcf563eae5589ef2))
* **code:** `dcode_term_program` trace metadata ([#5329](https://github.com/birhantprkc/deepagents/issues/5329)) ([8d3a1a9](https://github.com/birhantprkc/deepagents/commit/8d3a1a929f7569630060ab68862b2a21c382d58c))
* **code:** add `--allow-fs-tools` filesystem tool allowlist to dcode ([#4635](https://github.com/birhantprkc/deepagents/issues/4635)) ([3fbb85e](https://github.com/birhantprkc/deepagents/commit/3fbb85e3565f270f3a567f771ebd28323f10245d))
* **code:** add `/context` usage report ([#5407](https://github.com/birhantprkc/deepagents/issues/5407)) ([0355416](https://github.com/birhantprkc/deepagents/commit/0355416c0d4817ac58d3e14aa8b7ab099b6db74d))
* **code:** add `DeepSeek-V4-Pro-0813` to model picker ([#5512](https://github.com/birhantprkc/deepagents/issues/5512)) ([f23d81b](https://github.com/birhantprkc/deepagents/commit/f23d81b910b7c3343fda293d70f0a75d44f45ba0))
* **code:** add `install` subcommand ([#5080](https://github.com/birhantprkc/deepagents/issues/5080)) ([2f2116d](https://github.com/birhantprkc/deepagents/commit/2f2116d5cd7bba98e1b0731d5da760a4b93ffb37))
* **code:** add `reconnect`/`connect` hidden keywords for `/restart` ([#4807](https://github.com/birhantprkc/deepagents/issues/4807)) ([99250ee](https://github.com/birhantprkc/deepagents/commit/99250ee1749c977e95389baafde3d358c953ea0f))
* **code:** add Baseten built-in pricing overrides ([#5312](https://github.com/birhantprkc/deepagents/issues/5312)) ([f34ffa0](https://github.com/birhantprkc/deepagents/commit/f34ffa0cb8c0c7943b116a753535df47e32de2a3))
* **code:** add built-in thread inspector skill ([#4769](https://github.com/birhantprkc/deepagents/issues/4769)) ([2d729b3](https://github.com/birhantprkc/deepagents/commit/2d729b30c5df7265e8062bccd38026b745c6cf02))
* **code:** add cache and context status row ([#5408](https://github.com/birhantprkc/deepagents/issues/5408)) ([2b3edf9](https://github.com/birhantprkc/deepagents/commit/2b3edf9ba4f3b43911f118b8e942374091602854))
* **code:** add Fireworks `kimi-k3` to model switcher ([#5082](https://github.com/birhantprkc/deepagents/issues/5082)) ([82e799c](https://github.com/birhantprkc/deepagents/commit/82e799c7191adcb3bf96eb0435d55edd58cc1883))
* **code:** add GLM-5.2-Fast and Kimi-K3 to recommended models ([#5072](https://github.com/birhantprkc/deepagents/issues/5072)) ([a33494e](https://github.com/birhantprkc/deepagents/commit/a33494ec580c289c58f725e19364fc21ef8cc26c))
* **code:** add Hooks v2 capability snapshots ([#4916](https://github.com/birhantprkc/deepagents/issues/4916)) ([8b4e508](https://github.com/birhantprkc/deepagents/commit/8b4e508d4664ef02e220854d50f5d98e0913aed8))
* **code:** add Hooks v2 execution engine ([#4880](https://github.com/birhantprkc/deepagents/issues/4880)) ([f0b198f](https://github.com/birhantprkc/deepagents/commit/f0b198faa220ad90f24713f08acc09d41e4a81de))
* **code:** add Hooks v2 session transcripts ([#4918](https://github.com/birhantprkc/deepagents/issues/4918)) ([ca86fbe](https://github.com/birhantprkc/deepagents/commit/ca86fbecca1a43facb4281397760c5e52edb1ddd))
* **code:** add Kimi K3 to model selector under OpenRouter ([#4803](https://github.com/birhantprkc/deepagents/issues/4803)) ([fc94bb7](https://github.com/birhantprkc/deepagents/commit/fc94bb7da9e66218de063aa4415dcf9717f15fce))
* **code:** add Meta `muse-spark-1.2` to model switcher ([#5389](https://github.com/birhantprkc/deepagents/issues/5389)) ([922b285](https://github.com/birhantprkc/deepagents/commit/922b285598be3b2ca6b3ec01e7362e31ad2014b2))
* **code:** add plugin list search ([#4765](https://github.com/birhantprkc/deepagents/issues/4765)) ([a6c20b1](https://github.com/birhantprkc/deepagents/commit/a6c20b1a4d2a8b8a03690460a30c501ab7fbb6cb))
* **code:** add project hooks workspace trust ([#5105](https://github.com/birhantprkc/deepagents/issues/5105)) ([9b2185b](https://github.com/birhantprkc/deepagents/commit/9b2185b65d4cbbaad9dd1b632162810a0aefd7eb))
* **code:** add typed hooks data models ([#4870](https://github.com/birhantprkc/deepagents/issues/4870)) ([0967012](https://github.com/birhantprkc/deepagents/commit/09670121b8d20fa8029804143852f6fcc6135dba))
* **code:** allow muting the "YOLO is active" toast ([#5103](https://github.com/birhantprkc/deepagents/issues/5103)) ([4d2d6ae](https://github.com/birhantprkc/deepagents/commit/4d2d6aed808575e2e03539bc7fa84562c93b7eb5))
* **code:** auto-update installed plugins ([#5368](https://github.com/birhantprkc/deepagents/issues/5368)) ([3bf6ca7](https://github.com/birhantprkc/deepagents/commit/3bf6ca7ac076bc0330b65d244e3b46f398674de8))
* **code:** classifier-backed Auto approval mode ([#4804](https://github.com/birhantprkc/deepagents/issues/4804)) ([eae7c28](https://github.com/birhantprkc/deepagents/commit/eae7c28f1152a5116b5b330c9fa1088ce173656d))
* **code:** click the splash `thread` ID to copy it ([#5173](https://github.com/birhantprkc/deepagents/issues/5173)) ([be2e505](https://github.com/birhantprkc/deepagents/commit/be2e5054b9dffdf9ba9032a198c0ae5f8a0cccd1))
* **code:** configurable Auto classifier review timeout ([#5302](https://github.com/birhantprkc/deepagents/issues/5302)) ([7bd977b](https://github.com/birhantprkc/deepagents/commit/7bd977bc9d4c11aad90dbef7872d83c2affd584e))
* **code:** configure Auto goal criteria acceptance ([#4940](https://github.com/birhantprkc/deepagents/issues/4940)) ([37addfc](https://github.com/birhantprkc/deepagents/commit/37addfc8bb5533d6670d14defea38770c8d54d1e))
* **code:** debug-log skill-name override collisions ([#4772](https://github.com/birhantprkc/deepagents/issues/4772)) ([77603c6](https://github.com/birhantprkc/deepagents/commit/77603c69e2eeededf6f1df68b384da27f7d2843f))
* **code:** drop redundant `shell` and `web_search` prompt guidance ([#5213](https://github.com/birhantprkc/deepagents/issues/5213)) ([6305fdb](https://github.com/birhantprkc/deepagents/commit/6305fdbf8d94d061193a908715f2c629893b47ff))
* **code:** escape to manual mode in YOLO notice, mode slash commands ([#5092](https://github.com/birhantprkc/deepagents/issues/5092)) ([d93336b](https://github.com/birhantprkc/deepagents/commit/d93336bfca4664abc3994cb28970ea3fbeeb1b77))
* **code:** expand truncated `task` descriptions on click or `Ctrl+O` ([#4811](https://github.com/birhantprkc/deepagents/issues/4811)) ([2ddb551](https://github.com/birhantprkc/deepagents/commit/2ddb551bd77d210d689f3a75037259ade4fbf54a))
* **code:** frame HITL rejection reasons for the model ([#5259](https://github.com/birhantprkc/deepagents/issues/5259)) ([89c814b](https://github.com/birhantprkc/deepagents/commit/89c814b29249b44a8a6122f6c359db3601a6802e))
* **code:** gate debug console click-to-copy behind a checkbox ([#4810](https://github.com/birhantprkc/deepagents/issues/4810)) ([a485404](https://github.com/birhantprkc/deepagents/commit/a4854042e5fe9f3acf629b0646a6bf8e348ccc9a))
* **code:** include `yolo` mode in `Shift+Tab` approval cycle ([#5035](https://github.com/birhantprkc/deepagents/issues/5035)) ([9f2cc21](https://github.com/birhantprkc/deepagents/commit/9f2cc212dc3ba59540a9f738d2849e38ac9ecfc2))
* **code:** integrate Hooks v2 client lifecycle events ([#5104](https://github.com/birhantprkc/deepagents/issues/5104)) ([e8702df](https://github.com/birhantprkc/deepagents/commit/e8702df601e137b65fe276270c3d3d589340bddf))
* **code:** integrate Hooks v2 server lifecycle events ([#4997](https://github.com/birhantprkc/deepagents/issues/4997)) ([2487c4b](https://github.com/birhantprkc/deepagents/commit/2487c4b87dff264ae1e8d34c7ce9249dd4b29760))
* **code:** let the rubric grader inspect working-directory files ([#4835](https://github.com/birhantprkc/deepagents/issues/4835)) ([5dcf749](https://github.com/birhantprkc/deepagents/commit/5dcf749a6e7d5ab6611f30d485a3382c7ef31f22))
* **code:** load hooks from installed plugins ([#5198](https://github.com/birhantprkc/deepagents/issues/5198)) ([0828b02](https://github.com/birhantprkc/deepagents/commit/0828b02d30c7b5557ecfce7c4a4039e0d9c4c571))
* **code:** local pricing overrides as a fallback when genai-prices misses ([#5304](https://github.com/birhantprkc/deepagents/issues/5304)) ([89bcaf2](https://github.com/birhantprkc/deepagents/commit/89bcaf2c31ab347cb4cb4563bc18f296dbecea08))
* **code:** make Hooks v2 generally available ([#5307](https://github.com/birhantprkc/deepagents/issues/5307)) ([4edebde](https://github.com/birhantprkc/deepagents/commit/4edebdedd61d6793f0f7b666f5ee26b414576805))
* **code:** make plugins generally available ([#4797](https://github.com/birhantprkc/deepagents/issues/4797)) ([3da6e47](https://github.com/birhantprkc/deepagents/commit/3da6e471c26f1da4cddeb12a435bab92bd7866c6))
* **code:** make Version, Model, CWD copyable in Debug Console ([#4975](https://github.com/birhantprkc/deepagents/issues/4975)) ([52b8993](https://github.com/birhantprkc/deepagents/commit/52b8993489a9b6b92be077fe835743ef7704b6a0))
* **code:** migrate legacy hooks to v2 events ([#4971](https://github.com/birhantprkc/deepagents/issues/4971)) ([fdb585c](https://github.com/birhantprkc/deepagents/commit/fdb585c87b054979b8440bdc6ac97fc8ae628134))
* **code:** persist and reconfigure ACP sessions ([#5366](https://github.com/birhantprkc/deepagents/issues/5366)) ([22a36d2](https://github.com/birhantprkc/deepagents/commit/22a36d25d9e82902fa28cdacdcb51cd6a9b013d7))
* **code:** persist Debug Console `Ctrl+L` clear across reopen ([#4812](https://github.com/birhantprkc/deepagents/issues/4812)) ([20089a5](https://github.com/birhantprkc/deepagents/commit/20089a53703b031726fdc898831bb09f434527b7))
* **code:** personalize external editor hints ([#5445](https://github.com/birhantprkc/deepagents/issues/5445)) ([b72b3dd](https://github.com/birhantprkc/deepagents/commit/b72b3dd72e0a31962ebf19261dba547462b4e394))
* **code:** point back to the previous thread after a switch ([#5172](https://github.com/birhantprkc/deepagents/issues/5172)) ([4507f9f](https://github.com/birhantprkc/deepagents/commit/4507f9f1985f29e9d4af7577293da64ec12b131c))
* **code:** prompt to reconnect when leaving `/mcp` with pending toggles ([#5211](https://github.com/birhantprkc/deepagents/issues/5211)) ([53d1fb8](https://github.com/birhantprkc/deepagents/commit/53d1fb80cbd43f983782975d540fac34a11c4ccc))
* **code:** quieter diff hunks with word-level highlights ([#5106](https://github.com/birhantprkc/deepagents/issues/5106)) ([529f7e8](https://github.com/birhantprkc/deepagents/commit/529f7e8a16c7441873a305a9fa36c2721fa7a5b7))
* **code:** raise agent recursion limit to 2000 and make it configurable ([#4994](https://github.com/birhantprkc/deepagents/issues/4994)) ([94962a5](https://github.com/birhantprkc/deepagents/commit/94962a5f588ce84991ad382b7713155d6a5a231e))
* **code:** recognize LangSmith Gateway credentials ([#5042](https://github.com/birhantprkc/deepagents/issues/5042)) ([dcbff9c](https://github.com/birhantprkc/deepagents/commit/dcbff9c4d046bcd38ceef8e362691e8030036213))
* **code:** recommend DeepSeek V4 Flash 0731 ([#5244](https://github.com/birhantprkc/deepagents/issues/5244)) ([fbe4ec8](https://github.com/birhantprkc/deepagents/commit/fbe4ec8046c35313c6c05a986779111d84fe2536))
* **code:** refresh price catalog hourly in the background ([#5264](https://github.com/birhantprkc/deepagents/issues/5264)) ([2454afa](https://github.com/birhantprkc/deepagents/commit/2454afa58521f9dddb64bbde364a475694f45f4d))
* **code:** replace Gemini 3.5 Flash with 3.6 Flash in model switcher ([#4890](https://github.com/birhantprkc/deepagents/issues/4890)) ([5c99687](https://github.com/birhantprkc/deepagents/commit/5c99687bdecfd9e33051373581cacddbf7d0202a))
* **code:** resize chat input by dragging its top border ([#5524](https://github.com/birhantprkc/deepagents/issues/5524)) ([d01e4ac](https://github.com/birhantprkc/deepagents/commit/d01e4ac5bf36752e5c89c1c6645d486282cb611f))
* **code:** running session cost in status bar and usage ([#5036](https://github.com/birhantprkc/deepagents/issues/5036)) ([539d4a0](https://github.com/birhantprkc/deepagents/commit/539d4a04380182438ca63ba6b902eb921dc8a600))
* **code:** selectable model for the Auto approval classifier ([#5205](https://github.com/birhantprkc/deepagents/issues/5205)) ([1d3feb1](https://github.com/birhantprkc/deepagents/commit/1d3feb1275a875f84f96f04a07e47cb6ec974b78))
* **code:** show `ask_user` answers on the answered tool row ([#5100](https://github.com/birhantprkc/deepagents/issues/5100)) ([78ebe2d](https://github.com/birhantprkc/deepagents/commit/78ebe2d27c0ec5b5bf1368f1f1b1f442f9212717))
* **code:** show changelog link before install-script update prompt ([#5034](https://github.com/birhantprkc/deepagents/issues/5034)) ([e3d2a87](https://github.com/birhantprkc/deepagents/commit/e3d2a870b77e548611929be56952f68825d3d52e))
* **code:** show experimental mode in splash and debug console ([#4863](https://github.com/birhantprkc/deepagents/issues/4863)) ([44d9dec](https://github.com/birhantprkc/deepagents/commit/44d9dec39b2570d16c285a8b0a99cbe1afab4f1b))
* **code:** show thread message count in the Debug Console ([#5117](https://github.com/birhantprkc/deepagents/issues/5117)) ([04cf25d](https://github.com/birhantprkc/deepagents/commit/04cf25d27068070979552a5c914fc7dad715ce70))
* **code:** shutdown toast for deferred exits ([#4830](https://github.com/birhantprkc/deepagents/issues/4830)) ([a8a05f5](https://github.com/birhantprkc/deepagents/commit/a8a05f58f2ffb755bf373cd8f9a4cced2778370c))
* **code:** suggest compacting large resumed threads ([#5318](https://github.com/birhantprkc/deepagents/issues/5318)) ([cb2329d](https://github.com/birhantprkc/deepagents/commit/cb2329d1ec480455a7ba4e2b277cbd727c9215c7))
* **code:** summarize plugin changes on reload ([#4767](https://github.com/birhantprkc/deepagents/issues/4767)) ([9cad2f0](https://github.com/birhantprkc/deepagents/commit/9cad2f00dd0473828f80f782c889b939483727f6))
* **code:** surface Hooks v2 runtime feedback ([#5045](https://github.com/birhantprkc/deepagents/issues/5045)) ([66d526f](https://github.com/birhantprkc/deepagents/commit/66d526f0e43c4c1c5d3ab9cc3d423fefe1606e6f))
* **code:** toggle diff line numbers ([#5427](https://github.com/birhantprkc/deepagents/issues/5427)) ([4cd21b6](https://github.com/birhantprkc/deepagents/commit/4cd21b61592ef0239f59cf4e3f27a2a70d226737))
* **code:** tri-state `DEEPAGENTS_CODE_ONBOARDING` env var ([#5301](https://github.com/birhantprkc/deepagents/issues/5301)) ([43293e9](https://github.com/birhantprkc/deepagents/commit/43293e95cb072c8b92a734eca8c0292e45d279e8))
* **code:** warn above configurable session cost threshold ([#5405](https://github.com/birhantprkc/deepagents/issues/5405)) ([8cf8517](https://github.com/birhantprkc/deepagents/commit/8cf8517e7fb728fedd07db15a0577b305cd69f70))
* **sdk,code,quickjs:** make the `ToDoListMiddleware` list opt-in ([#4929](https://github.com/birhantprkc/deepagents/issues/4929)) ([9340518](https://github.com/birhantprkc/deepagents/commit/9340518a26c4287f9ad0c543edc9b69106c15154))


### Bug Fixes

* **code,evals:** unify goal activation signaling ([#4980](https://github.com/birhantprkc/deepagents/issues/4980)) ([0c4016e](https://github.com/birhantprkc/deepagents/commit/0c4016e3c8a7293fdf1a24e12340759068a2bb9a))
* **code:** abort project MCP approval on Esc ([#4888](https://github.com/birhantprkc/deepagents/issues/4888)) ([46bb1a8](https://github.com/birhantprkc/deepagents/commit/46bb1a86c8041d5c161d7cd07de66d068fb100c0))
* **code:** abort YOLO launch on `Ctrl+C`/`Ctrl+D` ([#4953](https://github.com/birhantprkc/deepagents/issues/4953)) ([e6ab9c0](https://github.com/birhantprkc/deepagents/commit/e6ab9c05e8fcb9a332396a9425e2b302607be823))
* **code:** add marketplaces asynchronously ([#4766](https://github.com/birhantprkc/deepagents/issues/4766)) ([0d1bb6a](https://github.com/birhantprkc/deepagents/commit/0d1bb6a1224b91cae9dcdb7014a6410a82b79001))
* **code:** allow cleanup of agent-created scratch files ([#4860](https://github.com/birhantprkc/deepagents/issues/4860)) ([fe08582](https://github.com/birhantprkc/deepagents/commit/fe08582a386b86f78f7a8047db067ea45e7e2650))
* **code:** allow safe OS-temp scratch artifacts ([#4869](https://github.com/birhantprkc/deepagents/issues/4869)) ([4330534](https://github.com/birhantprkc/deepagents/commit/4330534d18cbf79260842dde0e0c450312ef55ca))
* **code:** always restart after a successful startup auto-update ([#5317](https://github.com/birhantprkc/deepagents/issues/5317)) ([8cdee15](https://github.com/birhantprkc/deepagents/commit/8cdee15bbc54381229a686f8263656be0202b9b5))
* **code:** anchor toasts above the chat input ([#5101](https://github.com/birhantprkc/deepagents/issues/5101)) ([f1727c7](https://github.com/birhantprkc/deepagents/commit/f1727c785c44809e7b1b7ed8c5d0b31c560ae3ad))
* **code:** authorize Auto actions from active goal/rubric directives ([#5017](https://github.com/birhantprkc/deepagents/issues/5017)) ([728dbe7](https://github.com/birhantprkc/deepagents/commit/728dbe7df62ad9960f21cabd6e6c37e8d9a66da7))
* **code:** avoid blocking MCP OAuth token refresh ([#4770](https://github.com/birhantprkc/deepagents/issues/4770)) ([3b2ffce](https://github.com/birhantprkc/deepagents/commit/3b2ffce923e06370efe177e9ca91f70e86f19602))
* **code:** avoid detached spacer mount anchors ([#5516](https://github.com/birhantprkc/deepagents/issues/5516)) ([a38dc42](https://github.com/birhantprkc/deepagents/commit/a38dc4297b225e424207df5efd7dec0cf38ce832))
* **code:** avoid redundant Auto approval prompts ([#4993](https://github.com/birhantprkc/deepagents/issues/4993)) ([9975874](https://github.com/birhantprkc/deepagents/commit/9975874d897ada8979c084145eb730e15c9cf979))
* **code:** avoid tracking inline restart callers ([#4894](https://github.com/birhantprkc/deepagents/issues/4894)) ([0b071ef](https://github.com/birhantprkc/deepagents/commit/0b071ef71a1f0d63cb09de7ac528e030cd75af2e))
* **code:** bound Hooks v2 session-end teardown ([#5248](https://github.com/birhantprkc/deepagents/issues/5248)) ([28a7d5b](https://github.com/birhantprkc/deepagents/commit/28a7d5bdd3f78044b4f3612f71e13ce38ef47bf4))
* **code:** bust CDN cache on forced `dcode update` checks ([#4862](https://github.com/birhantprkc/deepagents/issues/4862)) ([3733526](https://github.com/birhantprkc/deepagents/commit/3733526f5faa187627c650435fa5478754c55fb4))
* **code:** clarify dependency warning prompt ([#5489](https://github.com/birhantprkc/deepagents/issues/5489)) ([31e4941](https://github.com/birhantprkc/deepagents/commit/31e49418c7538542ff30b2701cf8ac9d1182bbeb))
* **code:** clarify project hooks trust prompt and stop prompting for user hooks ([#5426](https://github.com/birhantprkc/deepagents/issues/5426)) ([61d3279](https://github.com/birhantprkc/deepagents/commit/61d32797ef85d1380e356cd2f9de1eb7926417ec))
* **code:** clear dynamic subagents on next turn ([#5437](https://github.com/birhantprkc/deepagents/issues/5437)) ([9a37479](https://github.com/birhantprkc/deepagents/commit/9a37479f866160f92474847720b57db9598ddb3e))
* **code:** consistent modal backdrop dimming for selectors ([#4990](https://github.com/birhantprkc/deepagents/issues/4990)) ([3606e3f](https://github.com/birhantprkc/deepagents/commit/3606e3f3fa2faac97f30141f9ee54e37631d16ad))
* **code:** consistent styling and links for thread status messages ([#5118](https://github.com/birhantprkc/deepagents/issues/5118)) ([9ad8dde](https://github.com/birhantprkc/deepagents/commit/9ad8dded08533a7915dc35e05f4c92c3b1ecb736))
* **code:** correct editable SDK detection to scan and correlate ([#5199](https://github.com/birhantprkc/deepagents/issues/5199)) ([4693ee7](https://github.com/birhantprkc/deepagents/commit/4693ee774771c5936ffa1783396aa4e2126211b1))
* **code:** count distinct targets in grouped tool summaries ([#5409](https://github.com/birhantprkc/deepagents/issues/5409)) ([cf8ea93](https://github.com/birhantprkc/deepagents/commit/cf8ea93a634b2ae03fa9033db6e0e240ed2ae1a1))
* **code:** count only running tools in live tool-group line ([#4809](https://github.com/birhantprkc/deepagents/issues/4809)) ([4d483fd](https://github.com/birhantprkc/deepagents/commit/4d483fdf39b6d7c691322041a4fc58be06ecfd6b))
* **code:** dedupe Auto classifier-unavailable transcript spam ([#5013](https://github.com/birhantprkc/deepagents/issues/5013)) ([9500306](https://github.com/birhantprkc/deepagents/commit/9500306a17f90dc2f27897c364c24cafffbc474a))
* **code:** disable LangSmith secret redaction by default ([#4970](https://github.com/birhantprkc/deepagents/issues/4970)) ([d029585](https://github.com/birhantprkc/deepagents/commit/d029585ab79432d00edfa5a70e77a31f2388ed5b))
* **code:** disentangle version diagnostics for editable installs ([#4816](https://github.com/birhantprkc/deepagents/issues/4816)) ([7408378](https://github.com/birhantprkc/deepagents/commit/7408378896344e4db7dbc45a35ae6b02cc746d31))
* **code:** drop `uv install` tip from `/version` update hint ([#4822](https://github.com/birhantprkc/deepagents/issues/4822)) ([4e618f0](https://github.com/birhantprkc/deepagents/commit/4e618f07b4b00f94133b4d1c105011c438cb35be))
* **code:** drop redundant `/restart` hint from restart prompt ([#5083](https://github.com/birhantprkc/deepagents/issues/5083)) ([b34899f](https://github.com/birhantprkc/deepagents/commit/b34899fccd051ab741000c771eef9a2dc4439d80))
* **code:** drop the "Message restored to input" toast ([#5253](https://github.com/birhantprkc/deepagents/issues/5253)) ([c206eb4](https://github.com/birhantprkc/deepagents/commit/c206eb450d612f77924ee55ecd136fbc52f459ab))
* **code:** explain why `doctor` has no latest-version answer ([#5209](https://github.com/birhantprkc/deepagents/issues/5209)) ([ef3e078](https://github.com/birhantprkc/deepagents/commit/ef3e078795e01b8334151081d026d6a88268d5a9))
* **code:** fire `PreCompact` before auto-compaction ([#5277](https://github.com/birhantprkc/deepagents/issues/5277)) ([f4cc516](https://github.com/birhantprkc/deepagents/commit/f4cc5160c75eb44e8ddee8b049048690ea0f8616))
* **code:** flag empty env override shadowing LangSmith key in `/trace` ([#4996](https://github.com/birhantprkc/deepagents/issues/4996)) ([313f952](https://github.com/birhantprkc/deepagents/commit/313f9520cef28c105aa53eac645176d422ec4a97))
* **code:** gate Hooks v2 behind `DEEPAGENTS_CODE_EXPERIMENTAL` ([#5146](https://github.com/birhantprkc/deepagents/issues/5146)) ([7d4acb6](https://github.com/birhantprkc/deepagents/commit/7d4acb6804cd17eb4c2337b9af11aee9f3601d01))
* **code:** give `config get` a useful missing-key message ([#4976](https://github.com/birhantprkc/deepagents/issues/4976)) ([260c33e](https://github.com/birhantprkc/deepagents/commit/260c33ee28ade91741ba226ef3e719b6b8c8c02c))
* **code:** handle malformed hook resumes ([#5233](https://github.com/birhantprkc/deepagents/issues/5233)) ([bd562c8](https://github.com/birhantprkc/deepagents/commit/bd562c879ad3a8eec0a930bba23ef57fee163c05))
* **code:** harden Hooks v2 command execution ([#4917](https://github.com/birhantprkc/deepagents/issues/4917)) ([05dd0d1](https://github.com/birhantprkc/deepagents/commit/05dd0d1bee7d79be6ac7f18db0d05b521e760326))
* **code:** harden installer downloads and paths ([#4871](https://github.com/birhantprkc/deepagents/issues/4871)) ([9a5bbeb](https://github.com/birhantprkc/deepagents/commit/9a5bbeb7558405054e970decfc1aef5b96a026f3))
* **code:** hide `Auto` option in approval widget when ineligible ([#4839](https://github.com/birhantprkc/deepagents/issues/4839)) ([1a1f06f](https://github.com/birhantprkc/deepagents/commit/1a1f06f506d5a167609de336cced740151b6615a))
* **code:** hide incomplete extras from version output ([#5352](https://github.com/birhantprkc/deepagents/issues/5352)) ([38f32cd](https://github.com/birhantprkc/deepagents/commit/38f32cdbfdfcf1728178dbee85a42751dd3f3d2e))
* **code:** hide invalid cache metrics ([#5475](https://github.com/birhantprkc/deepagents/issues/5475)) ([33a57cb](https://github.com/birhantprkc/deepagents/commit/33a57cbe6808e3da5f4067b7567f77845578ff61))
* **code:** hide startup tips when resuming threads ([#5349](https://github.com/birhantprkc/deepagents/issues/5349)) ([ff421f2](https://github.com/birhantprkc/deepagents/commit/ff421f2f316f3819d8ac92225ea032dabfbcefe9))
* **code:** hide timestamp footers with the rows they belong to ([#5167](https://github.com/birhantprkc/deepagents/issues/5167)) ([a3e3798](https://github.com/birhantprkc/deepagents/commit/a3e3798599705afd2d0a3fce8116df61f22a551d))
* **code:** honor MCP server disables for plugins ([#4848](https://github.com/birhantprkc/deepagents/issues/4848)) ([eea0a84](https://github.com/birhantprkc/deepagents/commit/eea0a84d9621565a707c161c2f22878771d9b38b))
* **code:** ignore LangSmith default US endpoint as custom target ([#5022](https://github.com/birhantprkc/deepagents/issues/5022)) ([ffb7aab](https://github.com/birhantprkc/deepagents/commit/ffb7aabe25d3d5ad7c5fce139f3bc3e14e245adf))
* **code:** ignore mouse hits on detached widgets ([#5114](https://github.com/birhantprkc/deepagents/issues/5114)) ([d4d2b60](https://github.com/birhantprkc/deepagents/commit/d4d2b60e37ae034e69f60ab5f34267b542c00dd5))
* **code:** improve `/rubric` help and empty-state messaging ([#5015](https://github.com/birhantprkc/deepagents/issues/5015)) ([1a3f46b](https://github.com/birhantprkc/deepagents/commit/1a3f46b85861779ed44e880cc7921cdd6f28fdfa))
* **code:** indent wrapped ask-user choices and add selection styling ([#5442](https://github.com/birhantprkc/deepagents/issues/5442)) ([a78d7b1](https://github.com/birhantprkc/deepagents/commit/a78d7b1744050c3221aab5e0c0300cc5f5bec519))
* **code:** inject OpenAI `prompt_cache_key` for any OpenAI-provider endpoint ([#4995](https://github.com/birhantprkc/deepagents/issues/4995)) ([6d6632f](https://github.com/birhantprkc/deepagents/commit/6d6632fa39822f1b774fcabd61ed371a90427113))
* **code:** keep `/update` and `/install --package` prompts responsive ([#5127](https://github.com/birhantprkc/deepagents/issues/5127)) ([5726872](https://github.com/birhantprkc/deepagents/commit/5726872cd5efec9367ae2ce678aa7183af74335d))
* **code:** keep `task` timers monotonic across nested subagent HITL ([#4771](https://github.com/birhantprkc/deepagents/issues/4771)) ([6952011](https://github.com/birhantprkc/deepagents/commit/69520118a7f96866a5e92e7b31894d8ba3312938))
* **code:** keep chat input responsive during `/restart` ([#4808](https://github.com/birhantprkc/deepagents/issues/4808)) ([a915c59](https://github.com/birhantprkc/deepagents/commit/a915c590dfb7c50d9bf697953ce724bad8dd4149))
* **code:** keep finished calls on live tool-group line ([#4927](https://github.com/birhantprkc/deepagents/issues/4927)) ([976c54b](https://github.com/birhantprkc/deepagents/commit/976c54b2e1392282044d9890a4a5d5d655f3e8dc))
* **code:** keep goal criteria proposal when marker clear fails ([#4785](https://github.com/birhantprkc/deepagents/issues/4785)) ([487b25f](https://github.com/birhantprkc/deepagents/commit/487b25f885c74b43ad2df837c6c0f6c45626be2a))
* **code:** keep harness-profile diagnostics out of terminal output ([#4943](https://github.com/birhantprkc/deepagents/issues/4943)) ([812bae4](https://github.com/birhantprkc/deepagents/commit/812bae4afad6749add097f9d58e489df9ec703a2))
* **code:** keep MCP shutdown-race traceback off the terminal ([#5325](https://github.com/birhantprkc/deepagents/issues/5325)) ([7d97097](https://github.com/birhantprkc/deepagents/commit/7d9709700dd24cc2477cd091f01de990f23ee4a9))
* **code:** keep paste placeholder when backspacing newline below it ([#4757](https://github.com/birhantprkc/deepagents/issues/4757)) ([ea82538](https://github.com/birhantprkc/deepagents/commit/ea825386b3c817f8461ea9e92c71de3411991e2a))
* **code:** keep post-install restart modal responsive ([#5086](https://github.com/birhantprkc/deepagents/issues/5086)) ([c4e2480](https://github.com/birhantprkc/deepagents/commit/c4e24804ebde93563f0596102bd5d9fc163ec0bf))
* **code:** keep server hook state out of task results ([#5164](https://github.com/birhantprkc/deepagents/issues/5164)) ([88ea7da](https://github.com/birhantprkc/deepagents/commit/88ea7da18e8be84e65df0edb8ffc4b904182f843))
* **code:** keep the `/goal` criteria prompt responsive ([#5142](https://github.com/birhantprkc/deepagents/issues/5142)) ([6f9ea6a](https://github.com/birhantprkc/deepagents/commit/6f9ea6a943dabe6c055766a43a204db6f4d95c98))
* **code:** log underlying Auto classifier failures ([#5011](https://github.com/birhantprkc/deepagents/issues/5011)) ([bd03e8a](https://github.com/birhantprkc/deepagents/commit/bd03e8a1ca4b38883e11148d5614a444cdefa407))
* **code:** make Auto mode generally available ([#4957](https://github.com/birhantprkc/deepagents/issues/4957)) ([1709dbf](https://github.com/birhantprkc/deepagents/commit/1709dbf9b27766aacce1a5a9c17396b3654f026c))
* **code:** make markdown `AppMessage` output selectable ([#4814](https://github.com/birhantprkc/deepagents/issues/4814)) ([2d6b2ce](https://github.com/birhantprkc/deepagents/commit/2d6b2ceeda97f8c77d1b3ea70c674b076e7d713f))
* **code:** make reject-with-feedback discoverable in approval menu ([#5260](https://github.com/birhantprkc/deepagents/issues/5260)) ([b1e3240](https://github.com/birhantprkc/deepagents/commit/b1e324038771c55460793e2e35d9d9ce5ea7b3f5))
* **code:** make YOLO warning friendlier for new users ([#4950](https://github.com/birhantprkc/deepagents/issues/4950)) ([fe07f39](https://github.com/birhantprkc/deepagents/commit/fe07f39ad78c5c09ea6959540a49196cd2f47f3e))
* **code:** move Auto mode path checks off the event loop ([#4856](https://github.com/birhantprkc/deepagents/issues/4856)) ([511203a](https://github.com/birhantprkc/deepagents/commit/511203a2c247f6756af3f06581ab9af761a4c4ef))
* **code:** offload server graph bootstrap cwd calls off the event loop ([#5081](https://github.com/birhantprkc/deepagents/issues/5081)) ([e05f7c2](https://github.com/birhantprkc/deepagents/commit/e05f7c2a825f3dc2fdfc075d4092b7b15d89b1a9))
* **code:** omit `plugins/` and `conversation_history/` from `/agent` picker ([#4991](https://github.com/birhantprkc/deepagents/issues/4991)) ([db26688](https://github.com/birhantprkc/deepagents/commit/db26688eee32232a1b73e98cc02642b5bf4165f4))
* **code:** open `/auto model` selector immediately while connecting ([#5341](https://github.com/birhantprkc/deepagents/issues/5341)) ([72bfc1e](https://github.com/birhantprkc/deepagents/commit/72bfc1e68574909ceb929be869c66fbdc9fe5a1d))
* **code:** preserve remembered MCP approvals with env allowlist ([#4889](https://github.com/birhantprkc/deepagents/issues/4889)) ([b513bf3](https://github.com/birhantprkc/deepagents/commit/b513bf3b2aaa30738da9b9b0ced1c001efb1bd5a))
* **code:** preserve runtime offload archive routing ([#5328](https://github.com/birhantprkc/deepagents/issues/5328)) ([768b061](https://github.com/birhantprkc/deepagents/commit/768b061805f65a36c71a1ad8f6a41b4e67063e91))
* **code:** prevent failed exit setup from stranding the app ([#4913](https://github.com/birhantprkc/deepagents/issues/4913)) ([e4d69b0](https://github.com/birhantprkc/deepagents/commit/e4d69b04a84de226d26d9ca3adea96f1337eef04))
* **code:** prevent post-tool hook replay ([#5376](https://github.com/birhantprkc/deepagents/issues/5376)) ([d37b54f](https://github.com/birhantprkc/deepagents/commit/d37b54f6bfb03f41fc7ff6b05436ad49db688d19))
* **code:** probe unreachable Ollama daemon once per reload ([#4806](https://github.com/birhantprkc/deepagents/issues/4806)) ([45baf6c](https://github.com/birhantprkc/deepagents/commit/45baf6c7a47e08e656ba56eb76beea30a9956403))
* **code:** put field descriptions on first-party tool schemas ([#5019](https://github.com/birhantprkc/deepagents/issues/5019)) ([4ccb873](https://github.com/birhantprkc/deepagents/commit/4ccb87325f3f97e416683233c94405e3ee105cda))
* **code:** queue `/copy` during active generation ([#5447](https://github.com/birhantprkc/deepagents/issues/5447)) ([8dfe282](https://github.com/birhantprkc/deepagents/commit/8dfe282006108dd0c47c50d5a1e3a41558e14723))
* **code:** quiet MCP auth-skip debug logging for known patterns ([#4805](https://github.com/birhantprkc/deepagents/issues/4805)) ([c2c27d6](https://github.com/birhantprkc/deepagents/commit/c2c27d621b63d5af18870e034f99355dc410cbda))
* **code:** refresh hooks after cwd switches ([#5249](https://github.com/birhantprkc/deepagents/issues/5249)) ([6f48dd5](https://github.com/birhantprkc/deepagents/commit/6f48dd59efd27c3476cf32cb8c965155c59993a5))
* **code:** release the turn when an interrupted worker never starts ([#5196](https://github.com/birhantprkc/deepagents/issues/5196)) ([42e01a9](https://github.com/birhantprkc/deepagents/commit/42e01a9585be8847aff6b97e520d7b84de922767))
* **code:** remove optional-provider startup tip ([#5421](https://github.com/birhantprkc/deepagents/issues/5421)) ([f137897](https://github.com/birhantprkc/deepagents/commit/f1378978e20f94762601ed38787a6fdb7fb39784))
* **code:** remove plugin type-to-search caret flash ([#5078](https://github.com/birhantprkc/deepagents/issues/5078)) ([7d69e37](https://github.com/birhantprkc/deepagents/commit/7d69e379678d8491ab62c9e229426d50b7366c45))
* **code:** remove undispatched `SessionEndCause` members ([#5240](https://github.com/birhantprkc/deepagents/issues/5240)) ([ee1e0f5](https://github.com/birhantprkc/deepagents/commit/ee1e0f50bfaff3690c6164147cdf22c94c289768))
* **code:** report Auto classifier timeout budget ([#5025](https://github.com/birhantprkc/deepagents/issues/5025)) ([516619b](https://github.com/birhantprkc/deepagents/commit/516619b7bf516e56f0e56ebc319dcab928c68c40))
* **code:** require `AGENTS.md` marker for `/agent` discovery ([#5076](https://github.com/birhantprkc/deepagents/issues/5076)) ([aff1435](https://github.com/birhantprkc/deepagents/commit/aff1435ce8d56c623cfeffb2731adcd4bf057c30)), closes [#4991](https://github.com/birhantprkc/deepagents/issues/4991)
* **code:** resolve underspecified goal objectives from conversation context ([#5201](https://github.com/birhantprkc/deepagents/issues/5201)) ([8fdb9c3](https://github.com/birhantprkc/deepagents/commit/8fdb9c306fd9a5b5368eb065b100cbfe8c8cbc58))
* **code:** restore `"Server log preserved at:"` notice on exit ([#4999](https://github.com/birhantprkc/deepagents/issues/4999)) ([5bc7714](https://github.com/birhantprkc/deepagents/commit/5bc7714fe55a73ac4892deb1785522ea310607ce))
* **code:** restore edit diffs in resumed threads ([#5391](https://github.com/birhantprkc/deepagents/issues/5391)) ([6a5d93f](https://github.com/birhantprkc/deepagents/commit/6a5d93f9ba7391189f65e6b999b724253577085d))
* **code:** resume hints echo the launched command name ([#5119](https://github.com/birhantprkc/deepagents/issues/5119)) ([991b7e7](https://github.com/birhantprkc/deepagents/commit/991b7e769d8afa98edc8dac1c68994ca4dc765d2))
* **code:** route `ctrl+x` to focused `ask_user` input ([#4926](https://github.com/birhantprkc/deepagents/issues/4926)) ([005f9bb](https://github.com/birhantprkc/deepagents/commit/005f9bb4d790e6cd92be8712ec86cd45192b699f))
* **code:** route failures to `PostToolUseFailure` ([#5315](https://github.com/birhantprkc/deepagents/issues/5315)) ([c1f4ac3](https://github.com/birhantprkc/deepagents/commit/c1f4ac3d53b3231d80be97691763850d230e8080))
* **code:** scope selection copy to the clicked screen ([#5140](https://github.com/birhantprkc/deepagents/issues/5140)) ([4de6037](https://github.com/birhantprkc/deepagents/commit/4de6037cbe31de005a493eaa719f5269f29be764))
* **code:** serialize dcode self-upgrades across processes ([#5252](https://github.com/birhantprkc/deepagents/issues/5252)) ([e12acba](https://github.com/birhantprkc/deepagents/commit/e12acbac89e553048b03fb6132b53e61b3433271))
* **code:** share MCP approvals across Git worktrees ([#4939](https://github.com/birhantprkc/deepagents/issues/4939)) ([467f9dd](https://github.com/birhantprkc/deepagents/commit/467f9dd0400087c2918bcf19f270bd934cec623a))
* **code:** shorten Auto classifier selection message ([#5446](https://github.com/birhantprkc/deepagents/issues/5446)) ([c43919c](https://github.com/birhantprkc/deepagents/commit/c43919c5c05643d03cf00009339cd0e4d3c17d6d))
* **code:** show `-m` prompt as queued immediately on startup ([#4861](https://github.com/birhantprkc/deepagents/issues/4861)) ([d0e148a](https://github.com/birhantprkc/deepagents/commit/d0e148a72612137fc7bc1e49a8972643e0ca2c28))
* **code:** show Auto enable notice modal only on first global enable ([#5012](https://github.com/birhantprkc/deepagents/issues/5012)) ([c2dbd17](https://github.com/birhantprkc/deepagents/commit/c2dbd176f06ff1a29637107101ae61344a09fc59))
* **code:** show resume hint after crashes ([#5412](https://github.com/birhantprkc/deepagents/issues/5412)) ([015a019](https://github.com/birhantprkc/deepagents/commit/015a0197f588e34475db63c2a03f04987583b081))
* **code:** show rubric grader defaults ([#4966](https://github.com/birhantprkc/deepagents/issues/4966)) ([465b9de](https://github.com/birhantprkc/deepagents/commit/465b9de17f9f4e6cd07a8674d9a186e60f5bf4d4))
* **code:** simplify paste expansion toast ([#5443](https://github.com/birhantprkc/deepagents/issues/5443)) ([217b9eb](https://github.com/birhantprkc/deepagents/commit/217b9eb372fa51b0439434f31abc3ac22e6cd7f2))
* **code:** skip grading during `/goal` proposals ([#4941](https://github.com/birhantprkc/deepagents/issues/4941)) ([d1ce66e](https://github.com/birhantprkc/deepagents/commit/d1ce66ea03e3726e6077c6700fc480209a849a7e))
* **code:** stabilize hook resumes across identity and Command tool results ([#5176](https://github.com/birhantprkc/deepagents/issues/5176)) ([08e6e8b](https://github.com/birhantprkc/deepagents/commit/08e6e8ba8d8ea629d78976542a061a2acab1fa9c))
* **code:** stop duplicating Auto transcript events on interrupt replay ([#5157](https://github.com/birhantprkc/deepagents/issues/5157)) ([5bbcf42](https://github.com/birhantprkc/deepagents/commit/5bbcf428a8131f0fca149abba34096fbcd2dfde8))
* **code:** stop leaking turn coroutines and sqlite handles ([#5218](https://github.com/birhantprkc/deepagents/issues/5218)) ([994799b](https://github.com/birhantprkc/deepagents/commit/994799b2f25950eb76e1085b5026d1f19eceb563))
* **code:** stop passing removed `checkpoint_metadata` ([#5473](https://github.com/birhantprkc/deepagents/issues/5473)) ([61ae398](https://github.com/birhantprkc/deepagents/commit/61ae398a60a2f6c23954d89332950570e0b6b431))
* **code:** store update logs under the OS cache dir ([#5363](https://github.com/birhantprkc/deepagents/issues/5363)) ([f69804b](https://github.com/birhantprkc/deepagents/commit/f69804bfce2673de4f2171664ac5b91c1c248ea0))
* **code:** surface `langchain-quickjs` in `/version` core deps ([#4813](https://github.com/birhantprkc/deepagents/issues/4813)) ([4112392](https://github.com/birhantprkc/deepagents/commit/41123924da6f6aa0243b51f2374210bee86df089))
* **code:** surface hook stops without agent errors ([#5276](https://github.com/birhantprkc/deepagents/issues/5276)) ([ed0e3e2](https://github.com/birhantprkc/deepagents/commit/ed0e3e236eea691d7c8c586ac1f9c82eba352b1a))
* **code:** thread `session_id` through forced-compaction fork ([#5492](https://github.com/birhantprkc/deepagents/issues/5492)) ([33d323c](https://github.com/birhantprkc/deepagents/commit/33d323c98bda90c7fe75bcf4a44fb083ed87fa81))
* **code:** thread id always copies on click in Debug Console ([#4945](https://github.com/birhantprkc/deepagents/issues/4945)) ([b4cb393](https://github.com/birhantprkc/deepagents/commit/b4cb3937bf8883e616f47621547a775ce9b29995))
* **code:** toast and expand long transcript user messages ([#5073](https://github.com/birhantprkc/deepagents/issues/5073)) ([a34713b](https://github.com/birhantprkc/deepagents/commit/a34713b122383dccad2572cd7213fd56f467fcce))
* **code:** toast model no-op notice instead of inline message ([#5074](https://github.com/birhantprkc/deepagents/issues/5074)) ([92b5193](https://github.com/birhantprkc/deepagents/commit/92b519391f584acb7786121469e45e850a94e06c))
* **code:** toast when media is dropped into a free-text question ([#5099](https://github.com/birhantprkc/deepagents/issues/5099)) ([da8d4c3](https://github.com/birhantprkc/deepagents/commit/da8d4c3ccc237e57294088d2437b13031a73c52d))
* **code:** trim `web_search` and `fetch_url` tool descriptions ([#5016](https://github.com/birhantprkc/deepagents/issues/5016)) ([170b4a6](https://github.com/birhantprkc/deepagents/commit/170b4a6c4590b3f95fb5219b5d9074c7f01a1937))
* **code:** use dismissed copy for ask-user prompts ([#5331](https://github.com/birhantprkc/deepagents/issues/5331)) ([920fb66](https://github.com/birhantprkc/deepagents/commit/920fb66763e85b759c2ec3cac090bccd7f05b55f))
* **code:** use SDK pin as effective editable version ([#4949](https://github.com/birhantprkc/deepagents/issues/4949)) ([1b270c8](https://github.com/birhantprkc/deepagents/commit/1b270c86fe24381c28d3ed35a31d754bd58bbf6e))
* **code:** warm MCP auth imports off event loop ([#4855](https://github.com/birhantprkc/deepagents/issues/4855)) ([75d37c3](https://github.com/birhantprkc/deepagents/commit/75d37c347556d962ff14850bdde489657c86feb4))
* **code:** warn on stale dependencies in editable installs ([#5386](https://github.com/birhantprkc/deepagents/issues/5386)) ([10353bd](https://github.com/birhantprkc/deepagents/commit/10353bda7196f307db9b22ef1173764aeda6daa7))


### Performance Improvements

* **code:** coordinate async shutdown teardown to cut exit latency ([#4831](https://github.com/birhantprkc/deepagents/issues/4831)) ([a2e501b](https://github.com/birhantprkc/deepagents/commit/a2e501b71f3d91769f56d5b3e433af8e03f7656e))
* **code:** refresh `/threads` cache after each turn ([#5174](https://github.com/birhantprkc/deepagents/issues/5174)) ([872f9d5](https://github.com/birhantprkc/deepagents/commit/872f9d5647759a84e7abfa79d43fc128c54e29a4))
* **code:** speed up local context detection ([#4922](https://github.com/birhantprkc/deepagents/issues/4922)) ([0b512d4](https://github.com/birhantprkc/deepagents/commit/0b512d4b79b1a03c7e452f1e76350cf726b1ec38))


### Reverted Changes

* **code,sdk:** revert `SystemPromptConfig` ([#4969](https://github.com/birhantprkc/deepagents/issues/4969)) ([d046427](https://github.com/birhantprkc/deepagents/commit/d046427b536c8ddbce5d804d6ae8b860511a9b44))
